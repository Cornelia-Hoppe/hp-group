...
export const Green = require("./backgrounds/bgGreen.png");
export const Yellow = require("./backgrounds/bgyellow.png");
export const Purple = require("./backgrounds/bgPurple.png");
export const Brown = require("./backgrounds/bgBrown.png");
